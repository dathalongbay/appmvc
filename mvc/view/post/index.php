    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div style="margin: 30px 0">
                <a href="index.php?controller=post&action=create" class="btn btn-success">thêm mới nhân viên</a>
            </div>
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div>
                                    <a class="btn btn-danger" href="index.php?controller=post&action=delete&id=<?php echo $row['id'] ?>">Xoá nhân viên</a>
                                </div>
                            </td>
                        </tr>
                        <?php
